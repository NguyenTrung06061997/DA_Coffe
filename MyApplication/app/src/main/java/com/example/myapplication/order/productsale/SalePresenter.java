...
import com.example.myapplication.data.api.handler.ApiHandler;
...
public class SalePresenter implements ISaleDrinks {
    private SaleDrinksView highLightView;

    public SalePresenter(SaleDrinksView highLightView) {
